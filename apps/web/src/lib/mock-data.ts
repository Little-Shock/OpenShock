...
export const workspace: WorkspaceSnapshot = {
  ...
  githubInstallation: {
    ...
    appConfigured: false,
    appInstalled: false,
    connectionMessage: "GitHub App 还没装好，先沿用本地仓库绑定继续推进。",
    syncedAt: "2026-04-07T05:35:00Z",
  },
  onboarding: {
    status: "in_progress",
...
export const channels: Channel[] = [
  {
    id: "all",
    name: "#all",
    summary: "轻松聊天、公屏唠嗑和快速交接。",
    unread: 5,
    purpose: "全局闲聊频道，轻量讨论先留在频道，正式工作再升级成讨论间。",
  },
  {
    id: "roadmap",
    name: "#roadmap",
    summary: "路线、优先级、产品分歧和排期讨论。",
    unread: 2,
    purpose: "路线图先讨论清楚，确认后再升级成真正的讨论间。",
  },
  {
    id: "announcements",
    name: "#announcements",
    ...
    unread: 0,
    purpose: "只发版本、Runtime 变化和制度公告，不在这里展开讨论。",
  },
];
...
export const agents: AgentStatus[] = [
  ...
  {
    id: "agent-build-pilot",
    name: "Build Pilot",
    description: "负责页面实现、交互收口，以及网站类需求的开发推进。",
    mood: "等待下一条开发接力",
    state: "idle",
    lane: "shared-dev",
    role: "执行推进",
    avatar: "builder-lantern",
    prompt: "先把页面骨架、关键信息区块和可点击路径落出来，再交给下一棒复核。",
    operatingInstructions: "围当前需求实现，不抢占 review / QA lane。",
    provider: "Codex CLI",
    providerPreference: "Codex CLI",
    modelPreference: "gpt-5.3-codex",
    recallPolicy: "governed-first",
    ...
    sandbox: {
      ...
      allowedCommands: ["git status", "pnpm test"],
      allowedTools: ["read_file", "rg"],
      updatedAt: "2026-04-08T09:36:00Z",
      updatedBy: "Larkspur",
    },
    recentRunIds: [],
    profileAudit: [],
  ...
  },
  {
    ...
    role: "Memory Steward",
    avatar: "ledger-stack",
    prompt: "把 next-run injection、promotion 和 version audit 记在同一条记录里，方便回看。",
...
export const fallbackState: PhaseZeroState = {
  ...
  runtimeScheduler: {
    ...
    summary: "当前仍指向工作区默认运行环境 shock-main。",
    candidates: [],
  },
  guards,
  memory: [],
