...
- Harness: `pnpm test:headed-runtime-lease-conflict-recovery -- --report docs/testing/Test-Report-2026-04-09-runtime-lease-conflict-recovery.md`
- Scope: `TKT-31 / CHK-14 / CHK-15 / TC-020 / TC-021`
- Result: `PASS`

## Environment

- server URL: `http://127.0.0.1:43572`
- web URL: `http://127.0.0.1:45194`
- runtimes:
...
- setup-lease-recovery: `/tmp/openshock-tkt69-7BB29c-artifacts/screenshots/01-setup-lease-recovery.png`
- agents-lease-recovery: `/tmp/openshock-tkt69-7BB29c-artifacts/screenshots/02-agents-lease-recovery.png`
- run-lease-recovery: `/tmp/openshock-tkt69-7BB29c-artifacts/screenshots/03-run-lease-recovery.png`
