...
- settings-before-write: `../tkt46-config-artifacts/run/screenshots/01-settings-before-write.png`
- settings-after-write: `../tkt46-config-artifacts/run/screenshots/02-settings-after-write.png`
- access-projection: `../tkt46-config-artifacts/run/screenshots/03-access-projection.png`
- setup-projection: `../tkt46-config-artifacts/run/screenshots/04-setup-projection.png`
- settings-after-server-restart: `../tkt46-config-artifacts/run/screenshots/05-settings-after-server-restart.png`
- second-device-recovery: `../tkt46-config-artifacts/run/screenshots/06-second-device-recovery.png`
